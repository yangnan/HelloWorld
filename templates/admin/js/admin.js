...
function helpscript(n){
	txtRun=n;window.open('/apps/admin/index.php/Index/helpview/','admin_help','toolbar=no,menubar=no,scrollbars=no, resizable=1, location=no, status=no,top=0,left=0,width=600,height=300')
...
function rundvscript(n,astr){
	txtRun=n;window.open("http://www.okpython.com/loadtemplates.asp?"+astr+"","loadtemplates")
}
