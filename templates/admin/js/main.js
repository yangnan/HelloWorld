...
//For full source code and more DHTML scripts, visit http://www.okpython.com
...
function mybook() {
  ...
  window.open("http://wwww.okpython.com", "我的服务",
...
function changeframeicon(img){
	if (!img){return false;}
	if (window == top){
		img.src = '/medias/admin/images/others/isleft.gif';
	}else{
		img.src = '/medias/admin/images/others/noleft.gif';
