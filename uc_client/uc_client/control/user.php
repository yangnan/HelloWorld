...
class usercontrol extends base {
	...
	//xiezhanhui加入获取所有用户信息
	function onget_user_all()
	{
		return $this->db->fetch_all("SELECT uid,username,email,regip as ip FROM ".UC_DBTABLEPRE."members ORDER by uid DESC");
	}
