<?php
$i_message['index_button'] = '全新安装，马上安装体验';
$i_message['install_welcome'] = '欢迎使用TGroupon团购化网络产品，请按照步骤执行安装操作。祝您拥有一个愉快的体验！';
$i_message['copyname'] = 'TGroupon V3.5 Beta免费版';
$i_message['install_title'] = 'TGrouponV3.5 Beta免费版 安装向导';
$i_message['install_wizard'] = '安装向导';
$i_message['install_warning'] = '<strong>注意 </strong>这个安装程序仅仅用在你首次安装TGroupon。如果你已经在使用 TGroupon或者要更新到一个新版本，请不要运行这个安装程序。';
$i_message['install_intro'] = '<h4>安装须知</h4><p>一、运行环境需求：PHP(5.2.x)+MYSQL(5.x)</p><p>二、安装步骤：<br /><br />1、使用ftp工具以二进制模式，将该软件包里的 TGroupon 目录及其文件上传到您的空间，假设上传后目录仍旧为 TGroupon。<br /><br />2、如果您使用的是Linux 或 Freebsd 服务器，先确认以下目录或文件属性为 (777) 可写模式。<br /><br />目录: templates_c<br />目录: cache<br />目录: config<br />目录: install<br />文件: config.inc.php<br />文件: define.inc.php<br /><br />3、运行 http://yourwebsite/TGroupon/install/install.php 安装程序，填入安装相关信息与资料，完成安装！<br />4、运行 http://yourwebsite/TGroupon/index.php 开始体验TGrouponV3.5！</p>';
$i_message['install_start'] = '开始安装TGroupon';
$i_message['install_license_title'] = '安装许可协议';
$i_message['install_lock'] = "您已经安装过了，如果想从新安装，请删除install目录下的install.lock文件。";
$i_message['install_license'] = '版权所有 (C) 2010-2012，TGroupon.com 保留所有权利。
TGroupon是由TGroupon项目组独立开发的SNS程序，基于PHP脚本和MySQL数据库。本程序源码开放的，任何人都可以从互联网上免费下载，并可以在不违反本协议规定的前提下进行使用而无需缴纳程序使用费。

官方网址： http://www.thinkgroupon.com 交流社区： http://www.thinkgroupon.com/bbs/

为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：

一、本授权协议适用且仅适用于TGroupon任何版本，TGroupon官方拥有对本授权协议的最终解释权和修改权。

二、协议许可的权利和限制
1、您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用，但我们也不承诺对个人用户提供任何形式的技术支持。
2、您可以在协议规定的约束和限制范围内修改TGroupon源代码或界面风格以适应您的网站要求，但不可以公开对外发布。
...
3、请务必仔细阅读本授权协议，在您同意授权协议的全部条件后，即可继续TGroupon的安装。即：您一旦开始安装TGroupon，即被视为完全同意本授权协议的全部内容，如果出现纠纷，我们将根据相关法律和协议条款追究责任。

';
$i_message['install_agree'] = '我已看过并同意安装许可协议';
$i_message['install_disagree'] = '不同意';
$i_message['install_disagree_license'] = '您必须在同意授权协议的全部条件后，方可继续TGroupon的安装';
$i_message['install_prev'] = '上一步';
$i_message['install_next'] = '下一步';
$i_message['add_ucenter'] = '添加ucenter数据库配置(注:可选择UC)';
$i_message['isuc'] = '是否使用ucenter';
$i_message['yesuc'] = '使用ucenter';
$i_message['nouc'] = '不使用ucenter';
$i_message['dirmod'] = '检测目录权限';
...
$i_message['mysql_unsupport'] = '您的服务器不支持MYSQL数据库，无法安装TGroupon。';
...
$i_message['install_mysql_prefix_intro'] = '同一数据库安装多TGroupon程序时可改变默认值';
...
$i_message['TGroupon_rebuild'] = '数据库中已经安装过 TGroupon，继续安装会清空原有数据！';
...
$i_message['install_success_intro'] = '<p>安装程序执行完毕，请尽快删除整个 install 目录，以免被他人恶意利用。如要重新安装，请删除本目录的 install.lock 文件！</p><p><a href="../index.php">请点击这里开始体验TGroupon吧！</a></p>';
$i_message['install_dbFile_error'] = '数据库文件无法读取，请检查/install/tgroupon_com.sql是否存在。';
$i_message['db_error'] = 'TGroupon数据库错误';
$i_message['re_install'] = '请重新安装';
?>
